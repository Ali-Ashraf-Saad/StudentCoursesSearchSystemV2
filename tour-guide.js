...
(function() {
  ...
  if (isIndex) {
    ...
    steps = [
      ...
      { selector: '.term-card:first-child .radio-group', title: 'طريقة الحساب', desc: 'مرونة كاملة! اختر الطريقة الأنسب لك: إما إدخال المعدل الفصلي الجاهز، أو إضافة المواد واختيار التقدير، أو إدخال الدرجة من 100 وكل الطريق تُؤدي لنفس النتيجة،  <br><small style="color:#fbbf24;">ملاحظة: لا تُدخِل مواد بـ 0 ساعة أو تحسبها في عدد المواد المسجلة فهي لا تؤثر (مثل قضايا مجتمعية).</small>', position: 'bottom', fallbackSelector: '.radio-group' },
